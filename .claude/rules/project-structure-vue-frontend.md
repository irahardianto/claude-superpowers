...
### Related Principles
- Project Structure @.claude/rules/project-structure.md (core philosophy)
- Vue Idioms and Patterns @.claude/rules/vue-idioms-and-patterns.md (Composition API, Pinia, composables)
- TypeScript Idioms and Patterns @.claude/rules/typescript-idioms-and-patterns.md (type system, async patterns)
