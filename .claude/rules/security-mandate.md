...
**When implementing security-sensitive features (auth, validation, queries), see Security Principles @.claude/rules/security-principles.md for detailed implementation guidance.**
