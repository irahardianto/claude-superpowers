...
- Reference: Security Mandate @.claude/rules/security-mandate.md
...
- Reference: Logging and Observability Mandate @.claude/rules/logging-and-observability-mandate.md

**3. Reduce Attack Surface**
- Remove unused code, dependencies, and endpoints.
- Expose the minimum necessary public interface (Least Privilege).
- Reference: Core Design Principles @.claude/rules/core-design-principles.md
...
- Reference: Resource and Memory Management Principles @.claude/skills/resources-and-memory-management/SKILL.md
...
- Reference: Testing Strategy @.claude/rules/testing-strategy.md
...
- Reference: Code Idioms and Conventions @.claude/rules/code-idioms-and-conventions.md
...
- Architectural Patterns — Testability-First Design @.claude/rules/architectural-pattern.md
