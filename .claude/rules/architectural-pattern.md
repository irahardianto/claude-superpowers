...
- E2E tests: isolated in a dedicated directory — `e2e/` at the project root for single-app projects, or `apps/e2e/` for monorepos. They cross feature boundaries and belong to none. See Testing Strategy @.claude/rules/testing-strategy.md for the complete E2E directory layout.
...
> For test pyramid proportions, naming conventions, tool choices, and language-specific tooling, see Testing Strategy @.claude/rules/testing-strategy.md.
...
- Database Design Principles @.claude/skills/database-design-principles/SKILL.md