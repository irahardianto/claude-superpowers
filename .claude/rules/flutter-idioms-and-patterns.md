...
- Project Structure — Flutter Mobile @.claude/rules/project-structure-flutter-mobile.md
...
- Dependency Management Principles @.claude/skills/dependency-management-principles/SKILL.md
