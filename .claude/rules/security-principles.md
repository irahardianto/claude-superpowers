...
- Configuration Management Principles @.claude/skills/configuration-management-principles/SKILL.md
- Command Execution Principles @.claude/skills/command-execution-principles/SKILL.md