...
| -------------------- | ---------------------------------- | ----------------------------------------------- |
| **Go**               | @.claude/rules/go-idioms-and-patterns.md         | Go services, APIs, CLI tools                    |
| **TypeScript**       | @.claude/rules/typescript-idioms-and-patterns.md | Any TypeScript project (backend, frontend, CLI) |
| **Vue 3**            | @.claude/rules/vue-idioms-and-patterns.md        | Vue components, Pinia stores, composables       |
| **Flutter / Dart**   | @.claude/rules/flutter-idioms-and-patterns.md    | Mobile apps, Flutter widgets, Riverpod          |
| **Rust**             | @.claude/rules/rust-idioms-and-patterns.md       | Rust binaries, libraries, workspaces            |
