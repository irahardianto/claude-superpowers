...
Observability is built on **three pillars** — this mandate governs Logs. For Metrics and Health Checks, see Monitoring and Alerting Principles @.claude/skills/monitoring-and-alerting-principles/SKILL.md.
...
For log levels, structured logging patterns, language-specific implementations, security considerations, and code examples, see Logging and Observability Principles @.claude/skills/logging-and-observability-principles/SKILL.md.

### Related Principles
- Logging and Observability Principles @.claude/skills/logging-and-observability-principles/SKILL.md
- Monitoring and Alerting Principles @.claude/skills/monitoring-and-alerting-principles/SKILL.md
