...
> For full diagnosis steps when a transition-stuck blank screen occurs, see the Debugging Protocol's [Frontend module](file://.claude/skills/debugging-protocol/languages/frontend.md) § CSS × Animation.
...
- TypeScript Idioms and Patterns @.claude/rules/typescript-idioms-and-patterns.md
- Project Structure — Vue Frontend @.claude/rules/project-structure-vue-frontend.md
