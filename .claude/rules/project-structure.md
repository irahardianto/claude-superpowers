...
| ------------------ | ------------------------------------ | ------------------------------------ |
| Go Backend         | @.claude/rules/project-structure-go-backend.md     | Go services, APIs, CLI tools         |
| Vue/React Frontend | @.claude/rules/project-structure-vue-frontend.md   | Web frontends (Vue, React, Svelte)   |
| Flutter/Mobile     | @.claude/rules/project-structure-flutter-mobile.md | Mobile apps (Flutter, React Native)  |
| Rust/Cargo         | @.claude/rules/project-structure-rust-cargo.md     | Rust binaries, libraries, workspaces |
