...
For implementation details (race condition prevention, deadlock avoidance, message passing patterns), see Concurrency and Threading Principles @.claude/skills/concurrency-and-threading-principles/SKILL.md.
...
- Performance Optimization Principles @.claude/skills/performance-optimization-principles/SKILL.md
- Rust Idioms and Patterns @.claude/rules/rust-idioms-and-patterns.md
