...
## References
- Go Idioms and Patterns @.claude/rules/go-idioms-and-patterns.md (§ Idiomatic Patterns, § Formatting and Static Analysis)
- Logging and Observability Principles @.claude/skills/logging-and-observability-principles/SKILL.md (§ Go/slog)
- Error Handling Principles @.claude/rules/error-handling-principles.md (§ Resource Cleanup)
