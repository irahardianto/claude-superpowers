...
## References
- Go Idioms and Patterns @.claude/rules/go-idioms-and-patterns.md
...
- Resources and Memory Management Principles @.claude/skills/resources-and-memory-management/SKILL.md
