...
- CI/CD Principles @.claude/skills/ci-cd-principles/SKILL.md (deployment vs release concept)
- Architectural Patterns — Testability-First Design @.claude/rules/architectural-pattern.md
- Core Design Principles @.claude/rules/core-design-principles.md (YAGNI)
- Security Mandate @.claude/rules/security-mandate.md (server-side evaluation)
