...
name: mobile-design
description: >-
  Generate distinctive, production-grade mobile interfaces for Flutter and React Native with
  platform-native patterns, adaptive layouts, and fluid motion. Use when building mobile app screens,
  widgets, or when the user requests visually striking mobile UI with proper iOS/Android conventions.
---
...
- Project Structure @.claude/rules/project-structure.md (Flutter/Mobile layout, feature organization)
- Testing Strategy @.claude/rules/testing-strategy.md (widget tests, integration tests)
- Security Principles @.claude/rules/security-principles.md (secure storage, API key handling)
- Accessibility Principles — load the `accessibility-principles` skill (screen reader, dynamic type, contrast)
- Architectural Patterns @.claude/rules/architectural-pattern.md (Riverpod 3 Notifier, repository pattern)
